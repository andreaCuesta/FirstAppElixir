...
# We’ve made a list of heroes using the DungeonCrawl.Character struct. The first line
# of our module uses the alias directive. This alias creates a shortcut, allowing us to # type only %Character to reference the struct.