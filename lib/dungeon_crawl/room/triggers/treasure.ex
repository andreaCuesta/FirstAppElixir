...
# if the player tries to search the room, she’ll find a healing potion. When the clause
# matches, the :search action will make the hero regain health. We use
# DungeonCrawl.Character.heal/2 to restore the hero’s health.